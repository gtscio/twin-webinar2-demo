...
if [ "$#" -ne 3 ]; then echo "Please provide a participant name, a service offering name and ID URL"
    exit -1
fi
...
--subject-did "$3" \
--issuers-dir /ext/identities --templates-dir /ext/templates --vc-dir /ext/credentials/evidences/service-offerings \
--valid-for 20000h
